...
import { Accordion, Avatar, Bar, Button, Calendar, Card, Column, Columns, ComparisonSlider, Empty, Icon, Menu, Meter, Nav, OffCanvas, Pagination, Panel, Parallax, position, Progress, Slider, Step, Tab, Table, Tile, Timeline, Toast, } from './';
var now = new Date();
var App = function () { return (React.createElement(OffCanvas, { sidebar: { content: React.createElement("span", null, "sidebar"), className: 'flex-centered' } },
    React.createElement("div", { style: {
        ...
        React.createElement(Table, { header: ['Name', 'Genre', 'Release date'], contents: [
                ['The Shawshank Redemption', 'Crime, Drama', '14 October 1994'],
                ['The Godfather', 'Crime, Drama', '24 March 1972'],
                ["Schindler's List", 'Biography, Drama, History', '4 February 1994'],
                ['Se7en', 'Crime, Drama, Mystery', '22 September 1995'],
            ] }),
        React.createElement(Toast, { content: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.", onClearClick: function () { return console.log('clear'); } }),
        React.createElement(Tab, { active: "1", onClick: function (e, id) { return console.log('tab: ', id); }, items: [
                { id: '1', name: 'Music', badge: 999 },
                { id: '2', name: 'Playlists' },
                { id: '3', name: 'Radio' },
            ] }),
        React.createElement(Step, { active: "4", items: [
        ...
        React.createElement(Nav, { onClick: function (e, key) { return console.log('clicked: ', key); }, items: [
                { id: '1', name: 'Elements' },
                {
                    id: '2',
                    name: 'Layout',
        ...
        React.createElement(Bar, { className: position({ marginBottom: true }), items: [
                {
                    role: 'progressbar',
                    style: { width: '25%' },
                    'aria-valuenow': 25,
        ...
        React.createElement(Accordion, { exclusive: true, useIcon: true, menus: [
                {
                    header: 'Elements',
                    contents: [
        ...
        React.createElement(Calendar, { lg: true, current: now, navFormat: "YYYY-MM", weekdays: ['日', '月', '火', '水', '木', '金', '土'], options: {
                data: [
            ...
            }, onMonthClick: function (e, m) { return console.log('month', m); }, onDateClick: function (e, d) { return console.log('click', d); } }),
