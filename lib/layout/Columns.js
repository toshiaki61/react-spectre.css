...
import Container from './Container';var babelPluginFlowReactPropTypes_proptype_ColumnsWithoutContainerProps = { children: typeof (React.DOM == null ? {} : React.DOM) === 'function' ? require('prop-types').instanceOf(React.DOM == null ? {} : React.DOM).isRequired : require('prop-types').any.isRequired, className: require('prop-types').string, gapless: require('prop-types').bool, oneline: require('prop-types').bool };if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_ColumnsWithoutContainerProps', { value: babelPluginFlowReactPropTypes_proptype_ColumnsWithoutContainerProps, configurable: true, enumerable: true });
...
};ColumnsWithoutContainer.propTypes = babelPluginFlowReactPropTypes_proptype_ColumnsWithoutContainerProps;
...
};Columns.propTypes = babelPluginFlowReactPropTypes_proptype_ColumnsProps;
