...
import uniqueId from './uniqueId';var bpfrpt_proptype_BaseInputProps = { className: PropTypes.string.isRequired, success: PropTypes.bool.isRequired, danger: PropTypes.bool.isRequired, sm: PropTypes.bool.isRequired, lg: PropTypes.bool.isRequired, textarea: PropTypes.bool.isRequired, slider: PropTypes.bool.isRequired };
...
BaseInput.defaultProps = {};var bpfrpt_proptype_InputProps = { className: PropTypes.string.isRequired, success: PropTypes.bool.isRequired, danger: PropTypes.bool.isRequired, sm: PropTypes.bool.isRequired, lg: PropTypes.bool.isRequired, textarea: PropTypes.bool.isRequired, slider: PropTypes.bool.isRequired, label: PropTypes.string, id: PropTypes.string };
