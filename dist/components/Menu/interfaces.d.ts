...
export declare type MenuItemProps = MenuItemDividerProps | MenuItemChildrenProps | MenuItemContentProps;
...
export declare type MenuProps = MenuAttrProps | MenuChildrenProps;
