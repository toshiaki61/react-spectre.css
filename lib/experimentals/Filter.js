...
import * as React from 'react';var babelPluginFlowReactPropTypes_proptype_ItemProps = { tag: require("prop-types").string.isRequired, title: require("prop-types").string.isRequired, subtitle: require("prop-types").string.isRequired };if (typeof exports !== "undefined") Object.defineProperty(exports, "babelPluginFlowReactPropTypes_proptype_ItemProps", { value: babelPluginFlowReactPropTypes_proptype_ItemProps, configurable: true, enumerable: true });var babelPluginFlowReactPropTypes_proptype_FilterProps = { tags: require("prop-types").shape({}).isRequired, data: require("prop-types").arrayOf(require("prop-types").shape({ tag: require("prop-types").string.isRequired, title: require("prop-types").string.isRequired, subtitle: require("prop-types").string.isRequired })).isRequired, active: require("prop-types").string.isRequired, onChange: require("prop-types").func.isRequired };if (typeof exports !== "undefined") Object.defineProperty(exports, "babelPluginFlowReactPropTypes_proptype_FilterProps", { value: babelPluginFlowReactPropTypes_proptype_FilterProps, configurable: true, enumerable: true });
...
var Filter = function Filter(_ref) {var tags = _ref.tags,data = _ref.data,active = _ref.active,onChange = _ref.onChange;return (
    React.createElement("div", { className: "filter" },
      ...
      React.createElement("div", { className: "filter-body columns" },
        ...
        }))));};Filter.propTypes = babelPluginFlowReactPropTypes_proptype_FilterProps;
