...
import Icon from '../elements/Icon';var bpfrpt_proptype_ItemProps = { src: PropTypes.string.isRequired, alt: PropTypes.string.isRequired };var bpfrpt_proptype_CarouselProps = { slides: PropTypes.arrayOf(PropTypes.shape({ src: PropTypes.string.isRequired, alt: PropTypes.string.isRequired }).isRequired).isRequired, active: PropTypes.string, onChange: PropTypes.func.isRequired };
...
{var slides = _ref.slides,active = _ref.active,onChange = _ref.onChange;
...
};Carousel.propTypes = bpfrpt_proptype_CarouselProps;
Carousel.defaultProps = {
  active: 'slide-0' };


export default Carousel;import PropTypes from 'prop-types';export { bpfrpt_proptype_ItemProps };export { bpfrpt_proptype_CarouselProps };