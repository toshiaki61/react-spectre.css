...
import { acquireContainerProps } from './Columns';var bpfrpt_proptype_SectionProps = { children: function children() {return (typeof (React.DOM == null ? {} : React.DOM) === 'function' ? PropTypes.instanceOf(React.DOM == null ? {} : React.DOM) : PropTypes.any).apply(this, arguments);}, className: PropTypes.string, center: PropTypes.bool };
