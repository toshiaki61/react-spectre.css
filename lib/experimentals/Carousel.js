...
import Icon from '../elements/Icon';var babelPluginFlowReactPropTypes_proptype_ItemProps = { src: require('prop-types').string.isRequired, alt: require('prop-types').string.isRequired };if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_ItemProps', { value: babelPluginFlowReactPropTypes_proptype_ItemProps, configurable: true, enumerable: true });var babelPluginFlowReactPropTypes_proptype_CarouselProps = { slides: require('prop-types').arrayOf(require('prop-types').shape({ src: require('prop-types').string.isRequired, alt: require('prop-types').string.isRequired })).isRequired, active: require('prop-types').string, onChange: require('prop-types').func.isRequired };if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_CarouselProps', { value: babelPluginFlowReactPropTypes_proptype_CarouselProps, configurable: true, enumerable: true });
...
};Carousel.propTypes = babelPluginFlowReactPropTypes_proptype_CarouselProps;
