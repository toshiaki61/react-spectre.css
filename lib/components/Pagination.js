...
function pages(current, total) {var each = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;var skip = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '...';
  ...
  return result;
}var babelPluginFlowReactPropTypes_proptype_ItemProps = { label: require('prop-types').string.isRequired, current: require('prop-types').number.isRequired, value: require('prop-types').number.isRequired, disabled: require('prop-types').bool, onClick: require('prop-types').func.isRequired };if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_ItemProps', { value: babelPluginFlowReactPropTypes_proptype_ItemProps, configurable: true, enumerable: true });
...
var Item = function Item(_ref) {var current = _ref.current,value = _ref.value,label = _ref.label,disabled = _ref.disabled,onClick = _ref.onClick;
  ...
  return (
    React.createElement('li', { className: classes },
      React.createElement('a', _extends({ href: sharp }, linkProp, { onClick: function (_onClick) {function onClick(_x3) {return _onClick.apply(this, arguments);}onClick.toString = function () {return _onClick.toString();};return onClick;}(function (e) {return onClick(e, value);}) }), label)));


};Item.propTypes = babelPluginFlowReactPropTypes_proptype_ItemProps;
Item.defaultProps = {
  disabled: false };var babelPluginFlowReactPropTypes_proptype_TitleProps = { title: require('prop-types').string.isRequired, subtitle: require('prop-types').string.isRequired, current: require('prop-types').number.isRequired, value: require('prop-types').number.isRequired, onClick: require('prop-types').func.isRequired };if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_TitleProps', { value: babelPluginFlowReactPropTypes_proptype_TitleProps, configurable: true, enumerable: true });
...
};Title.propTypes = babelPluginFlowReactPropTypes_proptype_TitleProps;var babelPluginFlowReactPropTypes_proptype_PaginationProps = { label: require('prop-types').shape({ previous: require('prop-types').oneOfType([require('prop-types').string, typeof (React.DOM == null ? {} : React.DOM) === 'function' ? require('prop-types').instanceOf(React.DOM == null ? {} : React.DOM) : require('prop-types').any]).isRequired, next: require('prop-types').oneOfType([require('prop-types').string, typeof (React.DOM == null ? {} : React.DOM) === 'function' ? require('prop-types').instanceOf(React.DOM == null ? {} : React.DOM) : require('prop-types').any]).isRequired, skip: require('prop-types').oneOfType([require('prop-types').string, typeof (React.DOM == null ? {} : React.DOM) === 'function' ? require('prop-types').instanceOf(React.DOM == null ? {} : React.DOM) : require('prop-types').any]).isRequired }).isRequired, total: require('prop-types').number.isRequired, current: require('prop-types').number.isRequired, each: require('prop-types').number.isRequired, title: require('prop-types').shape({ prev: require('prop-types').shape({ title: require('prop-types').string.isRequired, subtitle: require('prop-types').string.isRequired }).isRequired, next: require('prop-types').shape({ title: require('prop-types').string.isRequired, subtitle: require('prop-types').string.isRequired }).isRequired }).isRequired, onClick: require('prop-types').func.isRequired };if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_PaginationProps', { value: babelPluginFlowReactPropTypes_proptype_PaginationProps, configurable: true, enumerable: true });
...
};Pagination.propTypes = babelPluginFlowReactPropTypes_proptype_PaginationProps;
