    ...
    React.createElement(OffCanvas, {
      ...
      React.createElement('div', {
        ...
        React.createElement(Toast, {
          ...
          onClearClick: function onClearClick() {return console.log('clear');} }),
        ...
        React.createElement(Panel, {
          ...
          header: React.createElement('p', null, 'aaa'),
          content: 'test',
          footer: 'footer' }),
        ...
        React.createElement(Pagination, {
          total: 34,
          current: 1,
          onClick: function onClick(e, page) {return console.log('page: ', page);} }),
            ...
            React.createElement(Card, {
              items: [
              {
                ...
                content: {
                  ...
                  button:
                  React.createElement(Button, { primary: true, className: 'float-right' },
        ...
        React.createElement(Tile, {
          icon: React.createElement(Icon, { people: true, className: 'centered' }),
          compact: true,
          title: '\u30A2\u30A4\u30A6\u30A8\u30AA',
          subtitle: '\u30AB\u30AD\u30AF\u30B1\u30B3' }),
        ...
        React.createElement(Timeline, { timelines: ['March 2016', 'February 2017', 'March 2017'] },
          ...
          React.createElement('div', { className: 'tile' },
            React.createElement('div', { className: 'tile-content' },
              ...
              React.createElement('p', { className: 'tile-title' },
                React.createElement('a', { href: 'components.html#bars' }, 'Bars'), ': represent the progress of a task'),


              React.createElement('p', { className: 'tile-title' },
                React.createElement('a', { href: 'components.html#steps' }, 'Steps'), ': progress indicators of a sequence of task steps'),


              React.createElement('p', { className: 'tile-title' },
                React.createElement('a', { href: 'components.html#tiles' }, 'Tiles'), ': repeatable or embeddable information blocks')),
          ...
          React.createElement('div', { className: 'tile' },
            React.createElement('div', { className: 'tile-content' },
              ...
              React.createElement('p', { className: 'tile-title' },
                React.createElement('a', { href: 'elements.html#icons' }, 'Icons'), ': single-element, responsive and pure CSS icons'),


              React.createElement('p', { className: 'tile-title' },
                React.createElement('a', { href: 'components.html#popovers' }, 'Popovers'), ': small overlay content containers'),


              React.createElement('p', { className: 'tile-title' },
                React.createElement('a', { href: 'experimentals.html#calendars' }, 'Calendars'), ': date or date range picker and events display'),


              React.createElement('p', { className: 'tile-title' },
                React.createElement('a', { href: 'experimentals.html#carousels' }, 'Carousels'), ': slideshows for cycling images')),
        ...
        React.createElement(Slider, {
          value: 32,
          onChange: function onChange(e) {return console.log('slide:', e.target.value);} }))));};
