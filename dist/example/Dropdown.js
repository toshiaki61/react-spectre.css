...
var DropdownExample = /** @class */ (function (_super) {
    ...
    DropdownExample.prototype.render = function () {
        ...
        return (React.createElement(Dropdown, { initialValue: value, onMenuClick: handleMenuClick, contents: [{ id: 'e-1', link: '#accordions', content: 'Element 1' }], active: active, onClick: this.onClick, onBlur: handleBlur }));
    };
