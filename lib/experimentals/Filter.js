...
import * as React from 'react';var bpfrpt_proptype_ItemProps = { tag: PropTypes.string.isRequired, title: PropTypes.string.isRequired, subtitle: PropTypes.string.isRequired };var bpfrpt_proptype_FilterProps = { tags: PropTypes.objectOf(PropTypes.string.isRequired).isRequired, data: PropTypes.arrayOf(PropTypes.shape({ tag: PropTypes.string.isRequired, title: PropTypes.string.isRequired, subtitle: PropTypes.string.isRequired }).isRequired).isRequired, active: PropTypes.string.isRequired, onChange: PropTypes.func.isRequired };
...
var Filter = function Filter(_ref) {var
  tags = _ref.tags,
  data = _ref.data,
  active = _ref.active,
  onChange = _ref.onChange;return (
    ...
    React.createElement("div", { className: "filter" },
      ...
      React.createElement("div", { className: "filter-nav" },
        Object.keys(tags).map(function (key) {return (
            React.createElement("label", { key: key + "_nav", className: "chip", htmlFor: key },
              tags[key]));})),
      ...
      React.createElement("div", { className: "filter-body columns" },
        ...
        }))));};Filter.propTypes = bpfrpt_proptype_FilterProps;




export default Filter;import PropTypes from "prop-types";export { bpfrpt_proptype_ItemProps };export { bpfrpt_proptype_FilterProps };