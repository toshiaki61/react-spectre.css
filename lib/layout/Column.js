...
import classnames from 'classnames';var babelPluginFlowReactPropTypes_proptype_ColumnProps = { children: typeof (React.DOM == null ? {} : React.DOM) === 'function' ? require('prop-types').instanceOf(React.DOM == null ? {} : React.DOM).isRequired : require('prop-types').any.isRequired, className: require('prop-types').string, xs: require('prop-types').number, sm: require('prop-types').number, md: require('prop-types').number, lg: require('prop-types').number, xl: require('prop-types').number, size: require('prop-types').number };if (typeof exports !== 'undefined') Object.defineProperty(exports, 'babelPluginFlowReactPropTypes_proptype_ColumnProps', { value: babelPluginFlowReactPropTypes_proptype_ColumnProps, configurable: true, enumerable: true });
...
};Column.propTypes = babelPluginFlowReactPropTypes_proptype_ColumnProps;
Column.defaultProps = {
  className: '',
  xs: 0,
  sm: 0,
...
function () {
  ...
  i) {
    var func = function func(_ref3) {var children = _ref3.children,props = _objectWithoutProperties(_ref3, ['children']);return React.createElement(Column, _extends({ size: i }, props), children);};
